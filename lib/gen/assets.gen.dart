...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/ic_myfolder_disabled.svg
  String get icMyfolderDisabled => 'assets/images/ic_myfolder_disabled.svg';

  /// File path: assets/images/ic_mypage.svg
  String get icMypage => 'assets/images/ic_mypage.svg';
  ...
  /// File path: assets/images/ic_upload_disabled.svg
  String get icUploadDisabled => 'assets/images/ic_upload_disabled.svg';
...
class $AssetsTutorialsGen {
  const $AssetsTutorialsGen();

  /// File path: assets/tutorials/tutorial1.png
  AssetGenImage get tutorial1 =>
      const AssetGenImage('assets/tutorials/tutorial1.png');

  /// File path: assets/tutorials/tutorial2.png
  AssetGenImage get tutorial2 =>
      const AssetGenImage('assets/tutorials/tutorial2.png');

  /// File path: assets/tutorials/tutorial3.png
  AssetGenImage get tutorial3 =>
      const AssetGenImage('assets/tutorials/tutorial3.png');

  /// File path: assets/tutorials/tutorial4.png
