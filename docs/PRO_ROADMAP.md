...
1. **현재 진행 상황**: #11 (P0), #12 (P1 스키마 v2), #18 (크롬 확장 Apple 로그인) 완료. 그 외 전부 pending.
2. **다음 할 일**: **Task #13 (P1 — LocalFolderRepository 계층 조회 메서드)** 부터 시작. 그 다음 #17 → #14 → #15 → #16 순. 섹션 3.4 참조.
3. **환경 전제**:
