...
| `security-review` | 보안 검토 | 릴리즈 전, DB 작업 | `/security-review` |
...
# 테스트 커버리지 증가
> /project:test-agent "LocalFolderRepository 테스트 추가"
...
| Agent | 역할 | 사용 시점 | 설명 |
|-------|------|----------|------|
| `dev-agent` | TDD 기반 Flutter 개발 | 기능 개발 | Cubit/Repository 작성 시 TDD 적용 |
